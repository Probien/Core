...
func Migrate() {
	Database.AutoMigrate(&models.Category{}, &models.Customer{}, &models.BranchOffice{}, &models.Employee{}, &models.Product{}, &models.Endorsement{}, &models.PawnOrder{}, &models.Status{}, &models.SessionLog{}, &models.Moderation{}, &models.PaymentLog{})
}
