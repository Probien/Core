...
func (p *pawnOrderRouter) SetupRoutesAndFilter(v1 *gin.RouterGroup) {
	...
	v1.POST("/pawn-orders", p.createPawnOrder)
	v1.GET("/pawn-orders", p.getAllPawnOrders)
	v1.GET("/pawn-orders/:id", p.getPawnOrderById)
	v1.PATCH("/pawn-orders", p.updatePawnOrder)
}
